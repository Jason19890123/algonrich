  ...
  return (
    <div className='contactus_form mt-[150px]'>
      ...
      <div className='inline-block text-center mt-[20px]'>
        <div className='p-[5px]'><span>Admin@algonrich.com</span></div>
        <div className='p-[5px]'><span>Support@algonrich.com</span></div>
        <div className='p-[5px]'><span>Jobs@algonrich.com</span></div>
      </div>
    </div>
  );
};
